...
class _HomePageState extends State<HomePage> {
 ...
 /* getCurrentLocation()async{
    ...
    if(permission==LocationPermission.denied || permission==LocationPermission.deniedForever){
      ...
      log("Latitude=${currentposition.latitude.toString()}" as num);
      log("Longitude=${currentposition.longitude.toString()}" as num);
              ...
              trailing: IconButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) =>AddDocument(document: Document(name: '', description: '', imagePath: ''))
                      ,
                    ),
                  );
                },
