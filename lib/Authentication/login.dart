...
import 'package:is_fyp/Authentication/signup.dart';
import 'package:is_fyp/models/users.dart';
import 'package:is_fyp/SQLite/sqlite.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  login() async {
    ...
    if (response == true) {
      //If login is correct, then goto home page
      if (!mounted) return;
            ...
            child: Form(
              ...
              child: Column(
                children: [
                  ...
                  // We will disable this message in default, when user name and pass is incorrect we will trigger this message to user
                  isLoginTrue
                      ? const Text(
